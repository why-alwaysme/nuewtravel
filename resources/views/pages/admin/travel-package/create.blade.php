        ...
        <div class="card-body">
            <form action="{{route('travel-package.store')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="about" id="" class="d-block w-100 form-control" rows="10">{{old('about')}}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="depature_date" placeholder="Depature Date" value="{{old('depature_date')}}" >
                </div>
                <div class="form-group">
