          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <div class="members my-2">
                <img src="{{url('frontend/images/testimonial1.jpg')}}" class="member-image mr-1 rounded-circle">
                <img src="{{url('frontend/images/testimonial2.jpg')}}" class="member-image mr-1 rounded-circle">
                <img src="{{url('frontend/images/testimonial3.jpg')}}" class="member-image mr-1 rounded-circle"s>
              </div>
              <hr>
            ...
            <div class="join-container">
              ...
              <form action="{{Route('checkout_process', $item->id)}} " method="post">
                @csrf
                <button type="submit" class="btn btn-block mt-3 py-2 btn-join-now">Join Now</button>
              </form>
              @endauth
              @guest
